...
//        layout.setBackgroundColor(context.getResources().getColor(R.color.daidalos_backgroud));
                ...
                new FileChooserCore.OnFileSelectedListener()
                {
                            ...
                            String name)
                    {
                        ...
                        for (int i = 0; i < FileChooserDialog.this.listeners.size(); i++) {
                            FileChooserDialog.this.listeners.get(i)
                                    .onFileSelected(FileChooserDialog.this, folder, name);
                        }
                    }
                    ...
                    public void onFileSelected(File file)
                    {
                        ...
                        for (int i = 0; i < FileChooserDialog.this.listeners.size(); i++) {
                            FileChooserDialog.this.listeners.get(i)
                                    .onFileSelected(FileChooserDialog.this, file);
                        }
                    }
                });
    }
     ...
     *
     * @param onSelect
     *         'true' for show a confirmation dialog when selecting a file, 'false' if not.
     * @param onCreate
     *         'true' for show a confirmation dialog when creating a file, 'false' if not.
     */
    public void setShowConfirmation(
            boolean onSelect,
            boolean onCreate)
    {
