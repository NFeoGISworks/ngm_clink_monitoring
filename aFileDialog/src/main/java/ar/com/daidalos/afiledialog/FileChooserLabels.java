 ...
 */
public class FileChooserLabels
        implements Serializable
{
    ...
    /**
     * The label for the button for select the current folder (when using the file chooser for
     * select folders).
     */
     ...
     * <p/>
     * In this string, the character sequence '$file_name' is going to be replace by the file's
     * name.
     */
