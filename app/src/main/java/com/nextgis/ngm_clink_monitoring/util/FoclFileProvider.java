...
/*
 * Copyrigh(t) (C) 2013 The Android Open Source Project
 *
 ...
 * </p>
 */
public class FoclFileProvider extends ContentProvider {
    private static final String[] COLUMNS = {
            OpenableColumns.DISPLAY_NAME, OpenableColumns.SIZE };

    private static final String
            META_DATA_FILE_PROVIDER_PATHS = "com.nextgis.FILE_PROVIDER_PATHS";
     ...
     *
     * @param context A {@link Context} for the current component.
     * @param authority The authority of a {@link FoclFileProvider} defined in a
